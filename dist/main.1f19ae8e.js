...
var cliked = document.querySelector('.items');
var CreatPadding = document.querySelector(".mian-image");
...
_vanillaTilt.default.init(document.querySelector(".inner_box_1"), {
  max: 18,
  speed: 200
});

_vanillaTilt.default.init(document.querySelector(".inner_box_2"), {
  max: 18,
  speed: 200
});

_vanillaTilt.default.init(document.querySelector(".inner_box_3"), {
  max: 18,
  speed: 200
});
